...
//        public CWFPanel(string inName, Panel inPanel) : base(null, inName, EWindowType.Panel)
//        {
//            _panel = inPanel;

//            SetPVector2Param(EWindowParams.Size, new PVector2(_panel.Size.Width, _panel.Size.Height), false);
//        }
...
//            }
//            else if(inParamType == EWindowParams.Pivot_By_Parent
//                || inParamType == EWindowParams.Size)
//            {
//                Rect rect = GetRect();
//            }
//        }
